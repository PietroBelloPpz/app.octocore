...
myApp.onPageInit('login', function(page) {
	...
	//$('.page[data-page=login] form[name=login]').attr('action', octocore_url('signin', null));
	...
	$('.page[data-page=login] form[name=login]').validate({
		...
		submitHandler: function(form) {
			...
			$.post(octocore_url('signin_ajax', null), $(form).serialize(), function( data ) {
...
myApp.onPageInit('signup', function(page) {
    ...
    errorElement : 'div',
		...
		submitHandler: function(form) {
			...
			$.post(octocore_url('signup_ajax', null), $(form).serialize(), function( data ) {
...
myApp.onPageInit('user-profile', function(page) {
	...
	$.post(octocore_url('user', localStorage.octocore_id), filter, function( data ) {
		...
		$('.profile-header .user-name').html(user.first_name+ " "+user.second_name);
		$('.profile-header .user-avatar').attr('src',user.avatar);

		$('.card .user-name').html(user.first_name+ " "+user.second_name);
		$('.card .user-birthday').html(user.birthday);
		$('.card .user-location').html(user.location);
		$('.card .user-phone').html(user.phone);
		$('.card .user-email').html(user.email);
